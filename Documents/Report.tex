...
\clearpage{}
\sectionauthor{Evaluation (Balloon Application)}{Ryan Oswald}
\input{Evaluation.tex}

\clearpage{}
\sectionauthor{Evaluation (Content Submission)}{Alexander Macrae}
...
\clearpage{}
\section{Reflection}
\subsection{Andrew Dodd}
\input{Reflection-Andrew.tex}

\subsection{Alexander Macrae}
\input{Reflection-Alex.tex}

\subsection{William Reilly}
\input{Reflection-William.tex}

\subsection{Christopher Wyllie}
